...
email = st.text_input("On a besoin de ton adresse mail pour créer un compte utilisateur (pas de spam, promis !)" )

if email:
    st.write("Voici tes identifiants, note les bien pour accéder à la plateforme. Tu peux utiliser ton email ou ton username comme login")
